...
Why can time be traded for energy and vice versa? (with diminishing returns both ways)

If a photon is a galaxy-sized blob of mostly vectons, what does this imply about time at the metachemical level?  (think of a photon as a glider in Conway's game - the cells would be vectons then, right?)  The metachemical sieve has something like brownian motion--in many dimensions--at a rate that we would perceive of as vastly exceeding the speed of light in terms of information transmission.  Is this a problem?